...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        btnRadio->setObjectName(QStringLiteral("btnRadio"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        btnRadio->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_7->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("Widget", "QRadioButton", Q_NULLPTR));
    } // retranslateUi
