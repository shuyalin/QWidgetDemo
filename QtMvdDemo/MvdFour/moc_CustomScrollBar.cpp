...
struct qt_meta_stringdata_CustomScrollBar_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CustomScrollBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CustomScrollBar_t qt_meta_stringdata_CustomScrollBar = {
    {
QT_MOC_LITERAL(0, 0, 15) // "CustomScrollBar"
...
QT_INIT_METAOBJECT const QMetaObject CustomScrollBar::staticMetaObject = { {
    &QScrollBar::staticMetaObject,
    qt_meta_stringdata_CustomScrollBar.data,
    qt_meta_data_CustomScrollBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CustomScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomScrollBar.stringdata0))
