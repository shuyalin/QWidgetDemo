...
void CustomListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CustomListView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomListView::listViewPress)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void CustomListView::listViewPress()
{
